...
This directory is a local copy of `espressif/esp_lvgl_port` version `2.7.1`.

Upstream source:
- Repository: `https://github.com/espressif/esp-bsp`
- Component path: `components/esp_lvgl_port`
- Commit: `445ce421e4f0ff6b2c582969ff61e19252bd44fe`

Local change in this project:
- [`src/lvgl9/esp_lvgl_port_touch.c`](src/lvgl9/esp_lvgl_port_touch.c): replaced `ESP_ERROR_CHECK()` around touch reads with warning-and-return handling so transient I2C touch errors do not reboot the board.
