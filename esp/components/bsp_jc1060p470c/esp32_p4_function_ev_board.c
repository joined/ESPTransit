...
#include "jc1060p470c_lcd_config.h"
...
static const char *TAG = "JC1060P470C";
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    esp_lcd_dpi_panel_config_t dpi_config =
        JC1060P470C_JD9165_1024_600_PANEL_60HZ_DPI_CONFIG(LCD_COLOR_PIXEL_FORMAT_RGB565);

    jd9165_vendor_config_t vendor_config = {
        .init_cmds = jc1060p470c_jd9165_init_cmds,
        .init_cmds_size = sizeof(jc1060p470c_jd9165_init_cmds) / sizeof(jd9165_lcd_init_cmd_t),
        .mipi_config =
            {
