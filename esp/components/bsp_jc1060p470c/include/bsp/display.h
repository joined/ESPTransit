...
/* Physical panel dimensions - JC1060P470C (JD9165) */
#define BSP_LCD_H_RES     (1024)
#define BSP_LCD_V_RES     (600)

#define BSP_LCD_MIPI_DSI_LCD_HSYNC    (1208)
#define BSP_LCD_MIPI_DSI_LCD_HBP      (160)
#define BSP_LCD_MIPI_DSI_LCD_HFP      (160)
#define BSP_LCD_MIPI_DSI_LCD_VSYNC    (615)
#define BSP_LCD_MIPI_DSI_LCD_VBP      (21)
#define BSP_LCD_MIPI_DSI_LCD_VFP      (12)

#define BSP_LCD_MIPI_DSI_LANE_NUM (2)            // 2 data lanes
#define BSP_LCD_MIPI_DSI_LANE_BITRATE_MBPS (750) // 750 Mbps
