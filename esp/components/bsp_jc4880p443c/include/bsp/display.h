...
/* LCD display color format - RGB565 */
...
/* LCD display definition 480x800 - JC4880P443C */
#define BSP_LCD_H_RES              (480)
#define BSP_LCD_V_RES              (800)

#define BSP_LCD_MIPI_DSI_LCD_HSYNC    (12)
#define BSP_LCD_MIPI_DSI_LCD_HBP      (42)
#define BSP_LCD_MIPI_DSI_LCD_HFP      (42)
#define BSP_LCD_MIPI_DSI_LCD_VSYNC    (2)
#define BSP_LCD_MIPI_DSI_LCD_VBP      (8)
#define BSP_LCD_MIPI_DSI_LCD_VFP      (166)

#define BSP_LCD_MIPI_DSI_LANE_NUM          (2)    // 2 data lanes
#define BSP_LCD_MIPI_DSI_LANE_BITRATE_MBPS (500)  // 500 Mbps
...
/**
 * @brief Check if the panel's native 0° orientation is landscape
 */
static inline bool bsp_display_is_native_landscape(void)
{
