...
#include "jc4880p443c_lcd_config.h"
...
static const int BSP_LVGL_TASK_STACK_SIZE = 10240;
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    // JC4880P443C: ST7701 control panel with RGB565 via MIPI DSI
    ESP_LOGI(TAG, "Install ST7701 LCD control panel (JC4880P443C board)");
    esp_lcd_dpi_panel_config_t dpi_config = JC4880P443C_ST7701_480_800_PANEL_60HZ_DPI_CONFIG(LCD_COLOR_PIXEL_FORMAT_RGB565);

    st7701_vendor_config_t vendor_config = {
        .init_cmds = jc4880p443c_st7701_init_cmds,
        .init_cmds_size = sizeof(jc4880p443c_st7701_init_cmds) / sizeof(st7701_lcd_init_cmd_t),
        .flags = {
...
#endif
            .sw_rotate = cfg->flags.sw_rotate, /* SW rotation is supported for 90° and 270° */
        }
    };
...
lv_display_t *bsp_display_start(bool sw_rotate)
{
    bsp_display_cfg_t cfg = {
        ...
        .flags = {
            .buff_dma = true,  // RGB565 format
            .buff_spiram = true,
            .sw_rotate = sw_rotate,
        }
    };
    cfg.lvgl_port_cfg.task_stack = BSP_LVGL_TASK_STACK_SIZE;
