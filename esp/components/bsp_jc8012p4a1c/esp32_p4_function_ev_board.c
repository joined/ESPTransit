...
#include "jc8012p4a1c_lcd_config.h"
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    // JC8012P4A1C: JD9365 control panel with RGB565
    ESP_LOGI(TAG, "Install JD9365 LCD control panel (JC8012P4A1C board)");
    esp_lcd_dpi_panel_config_t dpi_config = JC8012P4A1C_JD9365_800_1280_PANEL_60HZ_DPI_CONFIG(LCD_COLOR_PIXEL_FORMAT_RGB565);

    jd9365_vendor_config_t vendor_config = {
        .init_cmds = jc8012p4a1c_jd9365_init_cmds,
        .init_cmds_size = sizeof(jc8012p4a1c_jd9365_init_cmds) / sizeof(jd9365_lcd_init_cmd_t),
        .mipi_config = {
